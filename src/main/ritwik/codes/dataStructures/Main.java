...
public class Main {
	...
	private void useLinkedList() {
		...
		list.insert(2);
		list.insert(3);
		printLineConsoleOutput("Content of List : " + list + "\tSize : " + list.getSize());
	...
	private void useStack() {
		...
		arrayStack.push(1);
		printLineConsoleOutput("Is Stack Empty : " + arrayStack.isEmpty());
		printLineConsoleOutput("Content of Stack : " + arrayStack);
		arrayStack.push(2);
		arrayStack.push(3);
		printLineConsoleOutput("Content of Stack : " + arrayStack);
		...
		printLineConsoleOutput("Is Stack Empty : " + linkedListStack.isEmpty());
		printLineConsoleOutput("Content of Stack : " + linkedListStack);
	...
	private void useQueue() {
		...
		printLineConsoleOutput("Contents of Queue : " + arrayQueue);
		...
		printLineConsoleOutput("Content of Stack : " + linkedListQueue);
